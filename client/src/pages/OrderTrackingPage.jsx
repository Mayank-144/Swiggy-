    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-black text-slate-900 tracking-tight">Order #{order.orderId}</h1>
        ...
        <span className="px-3 py-1 rounded-full text-xs font-black bg-emerald-100 text-emerald-800 border border-emerald-300 uppercase">
      ...
      <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-100 shadow-sm space-y-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-5 rounded-2xl bg-gradient-to-r from-swiggy-orangeLight via-amber-50 to-emerald-50 border border-swiggy-orange/30">
          <div className="flex items-center gap-3.5">
            <div className="w-12 h-12 rounded-2xl bg-swiggy-orange text-white flex items-center justify-center shadow-lg shadow-swiggy-orange/30 animate-bounce-light">
        ...
        <div className="relative py-4">
            ...
            {STAGES.map((stage, idx) => {
              ...
              return (
                <div key={stage.key} className="flex flex-col items-center text-center space-y-2">
                  ...
                  <div>
                    <h5 className={`font-extrabold text-xs tracking-tight ${isCompleted ? 'text-slate-900' : 'text-slate-400'}`}>
                      {stage.title}
                    </h5>
          ...
          <div className="absolute top-10 inset-x-8 h-1 bg-slate-100 -z-0">
            <div
        ...
        <div className="relative h-48 w-full rounded-2xl overflow-hidden bg-slate-900 border border-slate-800 shadow-inner flex items-center justify-center p-6">
          {/* Stylized dark map grid lines */}
          <div className="absolute inset-0 opacity-20 bg-[radial-gradient(#ffffff_1px,transparent_1px)] [background-size:16px_16px]" />
          
          {/* Visual Route with Moving Rider */}
          <div className="relative z-10 w-full max-w-lg flex items-center justify-between px-6">
            {/* Restaurant Pin */}
            <div className="flex flex-col items-center gap-1.5">
              <div className="w-10 h-10 rounded-2xl bg-amber-500 text-white flex items-center justify-center shadow-lg">
                <ChefHat className="w-5 h-5" />
              </div>
              <span className="text-[11px] font-bold text-amber-300 truncate max-w-[100px]">
            ...
            <div className="flex-1 mx-4 relative flex items-center">
              ...
              <motion.div
                ...
                className="absolute -top-3.5 p-1.5 rounded-full bg-swiggy-orange text-white shadow-glow-orange"
              >
            ...
            <div className="flex flex-col items-center gap-1.5">
              ...
              <span className="text-[11px] font-bold text-emerald-300 truncate max-w-[100px]">
            ...
            <div className="flex items-center gap-3.5">
              ...
              <div>
                <h5 className="font-extrabold text-sm text-slate-800 flex items-center gap-1.5">
                  ...
                  <span className="flex items-center gap-0.5 text-[10px] font-bold bg-amber-100 text-amber-800 px-1.5 py-0.5 rounded">
      ...
      <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-100 shadow-sm space-y-4">
        <h4 className="font-black text-base text-slate-900">Order Summary ({order.items?.length} items)</h4>
        ...
        <div className="pt-4 border-t border-slate-100 flex items-center justify-between">
          <span className="font-extrabold text-sm text-slate-800">Total Paid ({order.paymentMethod})</span>
          <span className="font-black text-lg text-swiggy-orange">₹{order.bill?.grandTotal}</span>
        </div>
      </div>
    </div>
  );
